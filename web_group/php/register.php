...
<?php
        ...
        if(empty($_POST)===false){
            $required_fields=array('first_name','last_name','reg_id','reg_password','retype_password','email','bday');
                ...
                <div id="register_form">
                    <form method="post" action="register.php" id=reg_form>
                        <table width="470px" id="font_color">
                            ...
                            <tr>
                                <td colspan="2">Date of Birth:<span id="errors">*</span> <br /> <input type="date" name="bday"></td>
                            </tr>
                            <tr>
