...
<?php 
    ...
    $change_data=array();
       ...
       if(empty($_POST)===false){
           $fields=array('First_Name','Last_Name','User_ID','Password','Email','DOB','Telephone','Gender','Educational_Level');
            ...
            if(empty($errors)){                
               if(empty($_POST['first_name'])===false){
                ...
                if(empty($_POST['bday'])===false){
                    $change_data[5]=$_POST['bday'];
                }
                else{
                   $change_data[5]=$user_data["DOB"]; 
                }
                
                if(empty($_POST['telephone'])===false){
                    $change_data[6]=$_POST['telephone'];
                }
                else{
                   $change_data[6]=$user_data["Telephone"]; 
                }
                
                if(empty($_POST['gender'])===false){
                    $change_data[7]=$_POST['gender'];
                }
                else{
                   $change_data[7]=$user_data["Gender"]; 
                }
                
                if(empty($_POST['education'])===false){
                    $change_data[8]=$_POST['education'];
                }
                else{
                   $change_data[8]=$user_data["Educational_Level"]; 
                }
    ...
    if(empty($user_data)===false){ 
                ...
                <table id="setting_table">
                    ...
                    <tr>
                        ...
                        <td><strong>DOB :</strong> <?php echo $user_data["DOB"];?></td>
        ...
        ?>
                    <form method="post" action="settings.php" id=change_form>
                        <table width="800px" id="font_color">
                            ...
                            <tr>
                                <td colspan="2">Date of Birth:<br /> <input type="date" name="bday"></td>
                            </tr>
                            <tr>
