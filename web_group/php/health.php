...
<html>
    ...
    <body class="log">        
        <div id="setting_form">
            <div id="form_inner">
                <img src=../images/health_banner.png>
                
                <h2 id="font_color">&nbsp;&nbsp;&nbsp;Health Care Category</h2>
                ...
                ?>               
                    <tr id="<?php echo $x;?>">
                        ...
                        <td><input type="button" value=Details onclick="location.href='health.php?jobname=<?php echo $job_name;?> && desc=<?php echo $description;?> && salary=<?php echo $salary;?> && company=<?php echo $company;?>'" ></td>
                        
                        <?php if($user_data["User_Category"]=="admin"){?>   
                        <td><input type="button" value="Remove" onclick="location.href='health.php?rm_jobID=<?php echo $rows['Job_ID'];?>'"></td>                    
                    </tr>      
                    <?php }else{?>
                        <td><input type="button" value="Apply" onclick="location.href='health.php?jobID=<?php echo $rows['Job_ID'];?>'"></td>
                    <?php }?>
                    </tr>      
                    ...
                    <script language="javascript">
                        ...
                        r.style.backgroundColor="#c7ead0";
                        }
                    </script>
                    <?php $x++; }?>
                </table>
