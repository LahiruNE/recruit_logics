...
<html>
    ...
    <body>        
        <div id="home_form">
            ...
            <div id="widjet2"><center><h3>Sell yourself</h3>
                <img src="../images/home.png" id="w2_image">
                <h4>Tell the world how talented you are and post your desired job!</h4>
                <h5><a href="sell.php">Click hear to sell yourself...</a></h5></center>
            </div>
