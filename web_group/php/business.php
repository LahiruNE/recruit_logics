    ...
    <body class="log">        
        <div id="setting_form">
            <div id="form_inner">
                ...
                <h2 id="font_color">&nbsp;&nbsp;&nbsp;Business and Finance Category</h2>
                ...
                ?>               
                    <tr id="<?php echo $x;?>">
                        ...
                        <td><input type="button" value=Details onclick="location.href='business.php?jobname=<?php echo $job_name;?> && desc=<?php echo $description;?> && salary=<?php echo $salary;?> && company=<?php echo $company;?>'" ></td>
                        
                        <?php if($user_data["User_Category"]=="admin"){?>   
                        <td><input type="button" value="Remove" onclick="location.href='business.php?rm_jobID=<?php echo $rows['Job_ID'];?>'"></td>                    
                    </tr>      
                    <?php }else{?>
                        <td><input type="button" value="Apply" onclick="location.href='business.php?jobID=<?php echo $rows['Job_ID'];?>'"></td>
                    <?php }?>
                    </tr>      
