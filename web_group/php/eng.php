...
<html>
    ...
    <body class="log">        
        <div id="setting_form">
            <div id="form_inner">
                <img src=../images/eng_banner.png>
                
                <h2 id="font_color">&nbsp;&nbsp;&nbsp;Engineering Category</h2>
                ...
                ?>               
                    <tr id="<?php echo $x;?>">
                        ...
                        <td><input type="button" value=Details onclick="location.href='eng.php?jobname=<?php echo $job_name;?> && desc=<?php echo $description;?> && salary=<?php echo $salary;?> && company=<?php echo $company;?>'" ></td>
                        
                     <?php if($user_data["User_Category"]=="admin"){?>   
                        <td><input type="button" value="Remove" onclick="location.href='eng.php?rm_jobID=<?php echo $rows['Job_ID'];?>'"></td>                    
                    </tr>      
                    <?php }else{?>
                        <td><input type="button" value="Apply" onclick="location.href='eng.php?jobID=<?php echo $rows['Job_ID'];?>'"></td>
                    <?php }?>
                    ...
                    <script language="javascript">
                        ...
                        r.style.backgroundColor="#f3e3e3";
                        }
                    </script>
                    <?php $x++; }?>
                </table>
